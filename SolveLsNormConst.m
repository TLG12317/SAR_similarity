formatSpec = '%f';
fileID = fopen('temp4.txt','r');
fileID2 = fopen('temp5.txt', 'r');
fileID3 = fopen('temp6.txt', 'r');

A = fscanf(fileID, formatSpec);
b = fscanf(fileID2, formatSpec);
k = fscanf(fileID3, formatSpec);
A = reshape(A, [k,k]);

normConst = 1;

function [ vX ] = SolveLsNormConstant( mA, vB, normConst )
% ----------------------------------------------------------------------------------------------- %
...
fprintf('\n---------- Call SolveLsNormConst.m ----------------\n')


[x] = SolveLsNormConstant( A, b, normConst );
csvwrite('b_under_50_50.txt', x);
